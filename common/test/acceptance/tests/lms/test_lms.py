...
class PayAndVerifyTest(EventsTestMixin, UniqueCourseTest):
    ...
    def test_immediate_verification_enrollment(self):
        ...
        self.wait_for_enrollment_event('edx.course.enrollment.activated', student_id)

        # Expect that one mode_changed enrollment event fired as part of the upgrade
        self.wait_for_enrollment_event('edx.course.enrollment.mode_changed', student_id)
    ...
    def wait_for_enrollment_event(self, event_type, target_student_id):
    ...
    def test_enrollment_upgrade(self):
        ...
        self.assert_no_matching_events_emitted(
            {
                'event_type': event_type,
                'event': {
                    'user_id': student_id
